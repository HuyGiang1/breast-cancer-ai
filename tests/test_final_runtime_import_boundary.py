...
def test_fastapi_import_does_not_load_legacy_prediction_service():
    code = "import sys; from app.main import app; assert 'app.services.prediction' not in sys.modules; assert 'app.services.prediction_dl' not in sys.modules; print(app.title)"
