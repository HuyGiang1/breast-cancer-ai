...
| DL calibration and error analysis | DONE | Platt selected by OOF validation reliability; threshold, errors and bootstrap CI generated; DL frozen | Pending reliability commit |
