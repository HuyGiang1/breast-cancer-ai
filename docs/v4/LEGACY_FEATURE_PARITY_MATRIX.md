...
| **PARTIALLY PRESERVED** | **3** | Features #28, #38, #41 |
| **FRONTEND REGRESSION — BACKEND PRESERVED** | **5** | Features #26, #27, #31, #33, #50 |
| **FULLY LOST** | **4** | Features #23, #30, #46, #47 |
| **SCIENTIFICALLY INCOMPATIBLE — REIMPLEMENT AGAINST FINAL MODEL** | **1** | Feature #24 (Grad-CAM on frozen EfficientNet-B0 `top_conv` — Batch C) |
...
| **Sum Reconciliation** | **52** | $2 + 10 + 18 + 7 + 3 + 5 + 4 + 1 + 0 + 2 = \mathbf{52}$ (Reconciled with 0 discrepancies) |
